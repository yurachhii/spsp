...
int NumberOfBooks = 0;
void modifybook(), LoadBooksFromFile(), SaveDataStudent(), SaveBooksToFile(), searchbook(), adminmenu(), displaymenu(), login(), regist();
void clearScreen() {
    system("cls");  
}
int indexstud;
...
void menu(), LoadStudentFromFile(), viewallbooks(), studentDashboard(), Invalid(), returnBook(), viewMyBook(), loginAndRegister(int userType), borrowbook();
